...
PRO pwr_frm_fts_test, data, dx=dx, dt=dt, doplot=doplot, gauss=gauss, errors=errors, ctrend=ctrend,$
                      fname=fname, signif_levels=signif_levels, smpad=smpad, tnog=tnog, vaughn=vaughn
